...
This feature extractor aims to give sound descriptions in real-time some from an incoming signal.
It uses the IRCAM descriptors library, which you can download for free here: https://forum.ircam.fr/projects/detail/max-sound-box/

This extractor is preset in order to work with Wekinator software.

In this extractor, there are ten different descriptors that cover a large span of sound characteristic :
